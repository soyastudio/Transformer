...
public class TRANSFORMER extends CommandLines {

    static {
        init(TRANSFORMER.class);
        ...
        options.addOption(Option.builder("z")
                .longOpt("serializer")
                .hasArg(true)
                .desc("Serializer or deserializer.")
                .required(false)
                .build());
    }
    ...
    public static void main(String[] args) {
        try {
            String result = execute(build(args));
